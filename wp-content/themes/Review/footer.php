    	...
    	<div class="footer_res">
		  ...
		  <?php } ?>
        	<div class="footer_main">
            	<p><strong><?php _e('Copyright','re');?></strong> © <strong>2014 - <a href="http://www.freeenergymedia.com/" target="_blank"><?php _e('Free Energy Media','re');?></a> </strong><?php _e(' All rights reserved.','re');?></p>
            </div>
        </div>
    </div>	 
<?php wp_footer(); ?>
